  	   	  ...
  	   	  <div class="col-md-9">
                 ...
                 <div class="contact-right">
						...
						<div class="alert alert-success" id="success_message">
  								<strong>Success!</strong>Added Contact						 
						</div>
						<?php }?>
						...
						<?php  $errors = PageContext::$response->validation_errors; ?>
							<form method="post" action="" name="edit-profile">
								...
								<input type="text" class="textbox"  id="name" placeholder="First name" name="first_name" value="" required>
								...
								<input type="text" class="textbox"  id="name" placeholder="Last Name" name="last_name" value="" required>
								</div>
								</div>
								</div>
								<div class="row">
								...
								<div class="form-group">
								<label>Email</label>
								<input type="email" class="textbox" placeholder="Email" name="email" value="" required>
								</div>
								</div>
								<div class="col-md-6">
								<div class="form-group">
								<label>Phone</label>
								<input type="text" class="textbox"  id="phone" name="phone_number" placeholder="" value=" " required>
								</div>
								</div>
								</div>
								<div class="row">
								...
								<div class="form-group">
								<label>Company</label>
								<input type="text" class="textbox"  id="company" name="company" placeholder="" value="" required>
								</div>
								</div>
								<div class="col-md-6">
								<div class="form-group">
